...
import { QUESTIONS } from "./epdsQuestions.ts";
...
void test("EPDS question wording, responses, ordering, and scores stay validated", () => {
  assert.deepStrictEqual(QUESTIONS, EXPECTED_QUESTIONS);
});
